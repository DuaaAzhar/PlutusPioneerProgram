...
module Week06.Token.OffChain (TokenParams (..), adjustAndSubmitWith, adjustAndSubmit, mintToken) where
...
adjustAndSubmitWith :: (PlutusTx.FromData (Scripts.DatumType a), PlutusTx.ToData(Scripts.RedeemerType a), PlutusTx.ToData (Scripts.DatumType a), AsContractError e)
                        => ScriptLookups a
...
-- function without submitting lookups
adjustAndSubmit :: (PlutusTx.FromData (Scripts.DatumType a), PlutusTx.ToData(Scripts.RedeemerType a), PlutusTx.ToData (Scripts.DatumType a), AsContractError e)
