...
mkValidator b d () ctx = traceIfFalse "beneficiary's signature missing" signedByBeneficiary &&
  ...
  where
    ...
    signedByBeneficiary = txSignedBy info $ unPaymentPubKeyHash $ beneficiary b
